...
import com.preseed.springdemo.baseservice.system.converter.RoleConverter;
...
import com.preseed.springdemo.baseservice.system.model.entity.RoleMenu;
import com.preseed.springdemo.baseservice.system.model.form.RoleForm;
import com.preseed.springdemo.baseservice.system.model.query.RolePageQuery;
import com.preseed.springdemo.baseservice.system.model.vo.RolePageVO;
import com.preseed.springdemo.baseservice.system.service.RoleMenuService;
...
@Resource
  ...
  @Override
  public Set<String> getPermissionByRoleIds(Set<Long> roleIds) {
    return roleMapper.findPermissionListByRoleIds(roleIds.stream().map(String::valueOf).collect(Collectors.joining(",")));
  }
    /**
     * 角色分页列表
     *
